...
class DashboardController extends AbstractController
{
    ...
    public function playersEditPage(Request $request, Player $player, PlayerRepository $playerRepo):Response
    {
        ...
        if($form->isSubmitted()){
            ...
            if($form->has('photoFile') && $form->get('photoFile')->getData()){
                $playerPhoto = $form->get('photoFile')->getData();
                $player->setPhoto($this->uploadFile($playerPhoto, 'app_player_add', ['id'=>$player->getId()]));
            }
            $playerRepo->save($player, true);
    ...
    public function buyPlayerPage(Request $request, Player $player, 
    PlayerRepository $playerRepo, TeamRepository $teamRepo, 
    EntityManagerInterface $entityManager, OperationRepository $operationRepo):Response
    {
        ...
        if($form->isSubmitted()){
            ...
            if((double) $amount > (double) $newTeamBalance){
    ...
    public function settings(Request $request, ParametersRepository $paramRepo, 
    ...
    UserRepository $userRepo, SluggerInterface $slugger): Response
    {
